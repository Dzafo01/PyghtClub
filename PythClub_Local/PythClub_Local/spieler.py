...
from interfaces import Permanent
            ...
            for message in mq.popAll("NEUE_USER_EINGABE_P1"):
                if isinstance(message, NeueUserEingabe_P1):   
                    ...
                    if message.ereignis == UserEingabe.LINKS_P1:
                        ...
                        self.speed_x=0
                    elif (message.ereignis == UserEingabe.PUNCH_P1) & (self.y == 50): # neu
                        self.attack.punch()
                        self.on_cooldown = False
                    elif (message.ereignis == UserEingabe.KICK_P1) & (self.y == 50): # neu
                        self.attack.kick()
                        self.on_cooldown = False 
        if self.player == 2:
            for message in mq.popAll("NEUE_USER_EINGABE_P2"):
                if isinstance(message, NeueUserEingabe_P2):    
                    ...
                    if message.ereignis == UserEingabe.LINKS_P2:
                        ...
                        self.speed_x=0
                    elif (message.ereignis == UserEingabe.PUNCH_P2) & (self.y == 50): # neu
                        self.attack.punch()
                        self.on_cooldown = False
                    elif (message.ereignis == UserEingabe.KICK_P2) & (self.y == 50): # neu
                        self.attack.kick()
                        self.on_cooldown = False
        self.y += self.speed_y
        self.x += self.speed_x
